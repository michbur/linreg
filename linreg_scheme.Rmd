...
C2==>D2[Q0_2. If the minimum value is 0, should I add a small epsilon to fluorescence values?]
...
subgraph questions
START2[Move from part 0]==>A2[QI_1. How to define start of the exponential phase  if there are no detectable jump?]
A2==>B2[QI_2. How to set a baseline as the average of the 6th and the 7th point below the plateau phase <br/> when plateau phase is not visible?]
B2==>C2[no questions]
C2==>D2[no questions]
